import Comm, binascii, UI_main, sys, serial, serial.tools.list_ports, threading, time,ctypes,inspect
...
class MainWindow(QMainWindow):
    ...
    def start_(self, id_):
        try:
            ...
            if button.text() == '开始':
                button.setText('停止')
                self.new_thread = new_sending(id_, self.addItem)
...
class new_sending(threading.Thread):
    ...
    def run(self):
        self.serial.port = self.addItem[self.id]
