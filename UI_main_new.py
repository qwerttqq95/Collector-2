...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon.addPixmap(QtGui.QPixmap(":/newPrefix/upgrade.ico"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        MainWindow.setWindowIcon(icon)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.layoutWidget = QtWidgets.QWidget(self.centralwidget)
        self.layoutWidget.setGeometry(QtCore.QRect(-30, 10, 341, 41))
        ...
        self.tableWidget.setGeometry(QtCore.QRect(10, 130, 641, 391))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton.setText(_translate("MainWindow", "选择升级包"))
        ...
        self.pushButton_2.setText(_translate("MainWindow", "全部开始"))
